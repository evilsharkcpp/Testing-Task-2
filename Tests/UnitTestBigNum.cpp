...
constexpr double multiplier { 1e12 };
...
TEST(BigPresisionTest, SquareTest) {
...
TEST(BigPresisionTest, QuadrangleAxes) {
     std::vector<Axis<double>> axes
     {
...
TEST(BigPresisionTest, NonSymmetryPentagonAxes) {
    std::vector<Axis<double>> axes{};
    Polygon<double> poly
    {
        std::vector<Point2<double>>
...
TEST(BigPresisionTest, EquilateralTriangleAxes) {
    std::vector<Axis<double>> axes
    {
...
TEST(BigPresisionTest, RectangleAxes) {
    std::vector<Axis<double>> axes
    {
...
TEST(BigPresisionTest, ParallelogramAxes) {
    std::vector<Axis<double>> axes{};
    Polygon<double> poly
    {
       std::vector<Point2<double>>
...
TEST(BigPresisionTest, SymmetricHexagonAxes) {
    std::vector<Axis<double>> axes
    {
